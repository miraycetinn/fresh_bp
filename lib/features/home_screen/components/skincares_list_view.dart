                  ...
                  ? FutureBuilder(
                      ...
                      builder: (context, data) {
                        ...
                        return ListView.builder(
                          ...
                          itemCount: data.data!.data!.skincaresListRef.length,
                          scrollDirection: Axis.horizontal,
                          itemBuilder: (BuildContext context, int index) {
                            final int count =
                                data.data!.data!.skincaresListRef.length > 10
                                    ? 10
                            ...
                            if (SkincareListDataRef.doc(data
                                        .data?.data?.skincaresListRef[index])
                                    .get() ==
                                null) return const CustomProgressIndicator();
                            return FutureBuilder(
                                future: SkincareListDataRef.doc(data
                                        .data!.data!.skincaresListRef[index])
                                    .get(),
