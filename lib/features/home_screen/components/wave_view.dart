          ...
          children: [
            ClipPath(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: FreshhAppTheme.nearlyDarkBlue.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      FreshhAppTheme.nearlyDarkBlue.withOpacity(0.2),
                      FreshhAppTheme.nearlyDarkBlue.withOpacity(0.5)
                    ],
            ...
            ClipPath(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    colors: [
                      FreshhAppTheme.nearlyDarkBlue.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: ScaleTransition(
                ...
                child: Container(
                  ...
                  height: 2,
                  decoration: BoxDecoration(
                    color: FreshhAppTheme.white.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: Transform(
                ...
                child: Container(
                  ...
                  height: 4,
                  decoration: BoxDecoration(
                    color: FreshhAppTheme.white.withOpacity(
            ...
            Column(
              children: [
                AspectRatio(
                  aspectRatio: 1,
                  child: Image.asset("assets/freshh_app/bottle.png"),
                ),
              ],
            )
          ],
